...
Prenda.create(nombre: "Gorra Nike",             textura:3, color: '#424BF5', color_secundario: '#CC0066', prenda_tipo_id: 1,  guardarropa_id: 1, usuario_id: 1)
Prenda.create(nombre: "Sombrero Hawaiano",      textura:3, color: '#42F548', color_secundario: '#42F5F2', prenda_tipo_id: 2,  guardarropa_id: 2, usuario_id: 1)
Prenda.create(nombre: "Chomba Fachera",         textura:3, color: '#FF1414', color_secundario: '#F24D00', prenda_tipo_id: 3,  guardarropa_id: 1, usuario_id: 1)
Prenda.create(nombre: "Camisa Dior",            textura:3, color: '#4795CC', color_secundario: '#4795CC', prenda_tipo_id: 4,  guardarropa_id: 2, usuario_id: 1)
Prenda.create(nombre: "Jean Lee",               textura:3, color: '#D1B40D', color_secundario: '#D1B40D', prenda_tipo_id: 14, guardarropa_id: 1, usuario_id: 1)
Prenda.create(nombre: "Short de la Academia",   textura:3, color: '#35EFF2', color_secundario: '#FFFFFF', prenda_tipo_id: 15, guardarropa_id: 2, usuario_id: 1)
Prenda.create(nombre: "Zapatillas Convers",     textura:3, color: '#FFFFFF', color_secundario: '#0800FF', prenda_tipo_id: 19, guardarropa_id: 1, usuario_id: 1)
Prenda.create(nombre: "Crocs",                  textura:3, color: '#FFFFFF', color_secundario: '#000000', prenda_tipo_id: 23, guardarropa_id: 2, usuario_id: 1)
